...
/***/ (function(module, exports, __webpack_require__) {
	...
	var movieEvents = __webpack_require__(13);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://stark-wildwood-66506.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var movieUi = __webpack_require__(15);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onOMDB = function onOMDB(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  if (ui.validate(data.movie.title) === true) {
	    api.omdbGet(data.movie.title).then(ui.omdbGetSuccess).catch(ui.omdbGetFailure);
	  } else {
	    ui.omdbGetFailure();
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = function update(data, targ) {
	  return $.ajax({
	...
	var omdbGet = function omdbGet(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showMoviesTemplate = __webpack_require__(16);
	var addMovieTemplate = __webpack_require__(36);
	var movieTitle = __webpack_require__(37);
	var omdbOutput = __webpack_require__(38);
	...
	var omdbStatus = function omdbStatus() {
	  var status = omdboOn;
	  return status;
	};
	...
	var toggle = function toggle() {
	  var omdb = document.querySelector('.omdb-section');
	...
	var destroySuccess = function destroySuccess(response) {
	...
	var destroy = function destroy(event) {
	  event.preventDefault();
	  var targ = $(event.target).attr('data-id');
	  api.destroy(targ).then(destroySuccess(event)).catch(destroyFailure);
	};

	// Fires upon successful update of list item
	var updateSuccess = function updateSuccess(response, data) {
	  var targ = $(response.target).attr('data-id');
	  var title = movieTitle({ movie: data.movie });
	...
	var update = function update(event) {
	  ...
	  if (validate(data.movie.title) === true) {
	    api.update(data, targ).then(updateSuccess(event, data)).catch(updateFailure());
	  } else {
	    updateFailure();
	  }
	};
	...
	var createSuccess = function createSuccess(response) {
	  var title = movieTitle({ movie: response.movie });
	  $('.core-alert').text('You have added ' + title + ' to your list of favorites');
	  var showMoviesHtml = addMovieTemplate({ movie: response.movie });
	...
	var indexSuccess = function indexSuccess(response) {
	  var showMoviesHtml = showMoviesTemplate({ movies: response.movies });
	  $('.content').append(showMoviesHtml);
	  $('.destroy').on('submit', destroy);
	  $('.update').on('submit', update);
	  var list = document.querySelector('.list-section');
	...
	var omdbGetSuccess = function omdbGetSuccess(response) {
	  if (response.Response !== 'False') {
	    var output = omdbOutput({ movie: response }); // This could fail => could be passing the wrong data through to handlebars
	...
	var omdbGetFailure = function omdbGetFailure(error) {
	...
	module.exports = {
	  ...
	  // showFailure,
	  validate: validate,
	  omdbGetSuccess: omdbGetSuccess,
	  omdbGetFailure: omdbGetFailure,
	  toggle: toggle,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div data-id=\""
	    ...
	    + "\">\n    <!--This also could be the key: getting movie.id in such a position that it can be\n    passed through to api.destroy-->\n    <div class=\"display-info\">\n\n      <h5>\n        "
	    ...
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <fieldset>\n          <input type=\"text\" name=\"movie[title]\" placeholder=\"Change Favorite\">\n          <input type=\"submit\" name=\"submit\" value=\"Update Movie\">\n        </fieldset>\n      </form>\n    </div>\n\n</div>\n\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.title : stack1), depth0))
	    + "\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div data-id=\""
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.Title : stack1), depth0))
	    + "</h5>\n  <h5>Released on "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.Released : stack1), depth0))
	    + "</h5>\n  <h5>Directed by "
	    ...
	    + "</h5>\n  <h5>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.Plot : stack1), depth0))
	    + "</h5>\n  <h5>Critical acclaim: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.Awards : stack1), depth0))
	    + "</h5>\n  <h5>Scored a "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.Metascore : stack1), depth0))
	    + " on Metacritic and a "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.imdbRating : stack1), depth0))
	    + " on IMDB</h5>\n\n</div>\n";
	},"useData":true});
